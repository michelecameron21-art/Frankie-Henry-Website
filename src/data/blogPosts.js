const blogPosts = [
    {
        ...
        content: `
            ...
            <p>If you've found your way here, chances are you've already met Frankie and Henry — two small but incredibly brave Yorkshire Terriers who find themselves on the adventure of a lifetime in the African wilderness.</p>
            <p><strong>Frankie and Henry: The Brave River Rescue</strong> is a children's picture book about courage, friendship, and the kind of bravery that comes from loving someone enough to face your fears. When their family goes on a safari holiday, Frankie and Henry discover a magical world called the Wild Place — where the animals talk, the dangers are real, and two little dogs must find a way to save the day.</p>
            <h2>Why We Created This Website</h2>
            <p>We wanted to build a place where young readers (and their grown-ups!) could explore the world of the book beyond its pages. Here you'll find:</p>
            <ul>
                <li><strong>Meet the Characters</strong> — get to know Frankie, Henry, Lwazi, Clawdius, and the rest of the Wild Place crew</li>
                <li><strong>The Rescue Run Game</strong> — help Frankie navigate the river in our free browser game</li>
                <li><strong>Colouring Pages &amp; Activities</strong> — free downloadable extras for creative little adventurers</li>
                <li><strong>Behind the Scenes</strong> — stories about the real Frankie and Henry who inspired the book</li>
            </ul>
        ...
        imageAlt: 'Frankie and Henry, two Yorkshire Terriers, on a magical safari adventure in Africa',
    },
    {
        id: 'why-yorkshire-terriers-make-best-adventure-heroes',
        title: 'Why Yorkshire Terriers Make the Best Adventure Heroes',
        metaDescription: 'Discover why Yorkshire Terriers are the perfect children\'s book heroes. From fearless Frankie to snack-loving Henry, Yorkies bring heart, humour, and bravery to every adventure.',
        date: '2026-03-30',
        author: 'Michele Cameron',
        ...
        content: `
            ...
            <p>Anyone who's ever lived with a Yorkshire Terrier knows the truth: they have absolutely no idea how small they are. Frankie, our real-life adventurer, once squared up to a German Shepherd at the park with the confidence of a lion. Henry watched from a safe distance, presumably calculating whether there were snacks involved.</p>

            <p>This is exactly the dynamic that makes them brilliant characters for children. Kids understand what it feels like to be small in a big world. They know what it's like to feel scared but do the brave thing anyway. A Yorkshire Terrier who charges into an African wilderness to rescue a lost jackal cub? That's every child who's ever stood up to something bigger than themselves.</p>

            <h2>The Frankie and Henry Dynamic</h2>

            <p>Every great adventure story needs two things: someone who leaps before they look, and someone who'd really rather not leap at all but does it anyway because they love their brother.</p>

            <p>That's Frankie and Henry in a nutshell.</p>

            <p><strong>Frankie</strong> is fearless. He's the first one through the tunnel, the first one to explore, the first one to say "let's go!" He doesn't think about danger — he thinks about the adventure. Children who are naturally brave see themselves in Frankie.</p>

            <p><strong>Henry</strong> is the heart of the story. He's scared. He's hungry. He'd genuinely prefer a nap. But when Frankie needs him — when a little jackal cub is crying for help — Henry shows up. Every single time. And that's the kind of bravery that matters most. Children who are quieter, more cautious, more thoughtful? They see themselves in Henry. And they learn that being brave doesn't mean being fearless.</p>

            <h2>Why Dogs Make Better Heroes Than People</h2>

            <p>There's something special about animal characters in children's books. They create a safe distance that lets children explore big emotions without feeling overwhelmed. When Henry is scared of the Monitor Lizard, a child can think about their own fears without the story feeling too close to home.</p>

            <p>Dogs in particular bring something unique: unconditional loyalty. Frankie doesn't rescue the jackal cub because it's the logical thing to do. He does it because someone needs help, and that's enough. Henry doesn't follow Frankie into danger because he's been told to. He follows because that's his brother, and you don't leave your brother.</p>

            <p>These are lessons that land differently when they come from two scruffy little Yorkies rather than a parent or teacher saying "be brave" or "help others."</p>
            ...
            <p>Yorkies were originally bred to catch rats in the mines and mills of northern England. They're working dogs disguised as lap dogs. Beneath that silky coat is a terrier with grit, determination, and a stubbornness that borders on heroic.</p>
